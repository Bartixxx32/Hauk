...
public enum Constants {
  ...
  public static final String SHARED_PREFS_AUTHORIZATIONS =
      "broadcastAuthorizations";
  public static final String SHARED_PREFS_DEVICE_SPECS = "deviceSpecs";

  // Keys for use in stored server preferences.
  public static final Preference<String> PREF_SERVER_ENCRYPTED =
      new Preference.EncryptedString("cryptServer", "");
  public static final Preference<ProxyTypeResolver> PREF_PROXY_TYPE =
      new Preference.Enum<>("proxyType", ProxyTypeResolver.SYSTEM_DEFAULT);
  public static final Preference<String> PREF_PROXY_HOST =
      new Preference.String("proxyHost", "localhost");
  public static final Preference<Integer> PREF_PROXY_PORT =
      new Preference.Integer("proxyPort", 9050);
  public static final Preference<Integer> PREF_CONNECTION_TIMEOUT =
      new Preference.Integer("connectTimeout", 10);
  public static final Preference<CertificateValidationPolicy>
      PREF_CERTIFICATE_VALIDATION = new Preference.Enum<>(
          "tlsCertValidation", CertificateValidationPolicy.VALIDATE_ALL);
  public static final Preference<String> PREF_USERNAME_ENCRYPTED =
      new Preference.EncryptedString("cryptUsername", "");
  public static final Preference<String> PREF_PASSWORD_ENCRYPTED =
      new Preference.EncryptedString("cryptPassword", "");
  public static final Preference<Integer> PREF_DURATION =
      new Preference.Integer("duration", 30);
  public static final Preference<Integer> PREF_INTERVAL =
      new Preference.Integer("interval", 1);
  public static final Preference<Integer> PREF_NO_GNSS_FALLBACK =
      new Preference.Integer("noGnssFallback", 45);
  public static final Preference<Float> PREF_UPDATE_DISTANCE =
      new Preference.Float("minUpdateDistance", 0.0F);
  public static final Preference<String> PREF_CUSTOM_ID =
      new Preference.String("requestLink", "");
  public static final Preference<Boolean> PREF_ENABLE_E2E =
      new Preference.Boolean("enableE2E", false);
  public static final Preference<String> PREF_E2E_PASSWORD =
      new Preference.EncryptedString("e2ePassword", "");
  public static final Preference<String> PREF_NICKNAME =
      new Preference.String("nickname", "");
  public static final Preference<Integer> PREF_DURATION_UNIT =
      new Preference.Integer("durUnit", Constants.DURATION_UNIT_MINUTES);
  public static final Preference<Boolean> PREF_ALLOW_ADOPTION =
      new Preference.Boolean("allowAdoption", true);
  public static final Preference<Boolean> PREF_RESTART_ON_BOOT =
      new Preference.Boolean("restartOnBoot", true);
  public static final Preference<NightModeStyle> PREF_NIGHT_MODE =
      new Preference.Enum<>("nightMode", NightModeStyle.FOLLOW_SYSTEM);
  public static final Preference<Boolean> PREF_CONFIRM_STOP =
      new Preference.Boolean("confirmStop", true);
  public static final Preference<Boolean> PREF_HIDE_LOGO =
      new Preference.Boolean("hideLogo", false);

  @Deprecated // Use PREF_SERVER_ENCRYPTED instead
  public static final Preference<String> PREF_SERVER =
      new Preference.String("server", "");
  @Deprecated // Use PREF_USERNAME_ENCRYPTED instead
  public static final Preference<String> PREF_USERNAME =
      new Preference.String("username", "");
  @Deprecated // Use PREF_PASSWORD_ENCRYPTED instead
  public static final Preference<String> PREF_PASSWORD =
      new Preference.String("password", "");
  ...
  public static final String DEVICE_PREF_WARNED_BATTERY_SAVINGS =
      "hasPromptedBatterySavings";

  // Regular expression for extracting a share ID from a URL when adopting a
  // share.
  ...
  public static final String EXTRA_BROADCAST_RECEIVER_REGISTRY_INDEX =
      "dataRegistryIndex";
  public static final String EXTRA_BROADCAST_AUTHORIZATION_IDENTIFIER =
      "source";
  ...
  // Minimum backend version that sends the link ID as well as the view link
  // itself.
  ...
  public static final Version VERSION_COMPAT_E2E_ENCRYPTION =
      new Version("1.5");
